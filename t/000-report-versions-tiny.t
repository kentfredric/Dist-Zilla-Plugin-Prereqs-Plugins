...
eval { $v .= pmver('Dist::Zilla::Plugin::Bootstrap::lib','0.03000101') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::Plugins','any version') };
...
eval { $v .= pmver('Dist::Zilla::Role::PrereqSource','4.300037') };
